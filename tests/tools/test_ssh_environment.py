...
class TestOneShotSSH:
    ...
    def test_state_does_not_persist(self):
        _run("export RAKSHASTRA_ONESHOT_TEST=yes")
        r = _run("echo $RAKSHASTRA_ONESHOT_TEST")
...
class TestPersistentSSH:
    ...
    def test_env_var_persists(self):
        _run("export RAKSHASTRA_PERSIST_TEST=works")
        r = _run("echo $RAKSHASTRA_PERSIST_TEST")
