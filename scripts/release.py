#!/usr/bin/env python3
"""Rakshastra Agent Release Script
...
VERSION_FILE = REPO_ROOT / "rakshastra_cli" / "__init__.py"
...
AUTHOR_MAP = {
    "adityatomar4877@gmail.com": "adityatomar4877-rgb",
    ...
    "121278003+Cossackx@users.noreply.github.com": "Cossackx",  # PR #52528 salvage (Windows rakshastra-shim resolution + prefer --update on recovery; #52378)
    ...
    "rakshastra@marian.local": "Schrotti77",
    ...
    "274096618+rakshastra-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "rakshastra@nousresearch.com": "NousResearch",
    ...
    "rakshastra@noushq.ai": "benbarclay",
    ...
    "rakshastra@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "agent@rakshastra.local": "jacdevos",
    ...
    "teknium@rakshastra-agent": "teknium1",
    ...
    "github@nadyarakshastra.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (RAKSHASTRA_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (RAKSHASTRA_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: rakshastra-eval community link)
    ...
    "rakshastraagent26@gmail.com": "rakshastraagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+rakshastraagent26@users.noreply.github.com": "rakshastraagent26",
    ...
    "vigo@rakshastra": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "hex.rakshastra@agentmail.to": "oseftg",
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Rakshastra runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level RAKSHASTRA_HOME state files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Rakshastra
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"rakshastra-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "rakshastra@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/rakshastra-agent",
    ...
    lines.append(f"# Rakshastra Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Rakshastra Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Rakshastra Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Rakshastra Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Rakshastra Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Rakshastra Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Rakshastra Agent v{new_version} ({calver_date})' "
